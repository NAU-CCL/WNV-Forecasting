...
mu1 <- 1/120  #(this is bird death)
mu <- 0.05  # (this is mosquito death)
i_year <- c(
  "2006" = 100,
  "2007" = 100,
  "2008" = 100,
...
for (iteration in 1:num_iterations) {
  ...
  if (iteration %in% c(46)) {
    ...
    # --- Parameter histograms ---
     png(paste0("Param_Hist_iteration0_", iteration, "_", Year, ".png"), width = 1200, height = 800)
     par(mfrow = c(2, 1))  
     for (i in 1:2) {
...
# Mosq+Human+NoClimate - Fit + Forecast +  Fan Charts
